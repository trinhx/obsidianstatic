...
`,x=function(t,e){let i=t.append("rect");return i.attr("x",e.x),i.attr("y",e.y),i.attr("fill",e.fill),i.attr("stroke",e.stroke),i.attr("width",e.width),i.attr("height",e.height),i.attr("rx",e.rx),i.attr("ry",e.ry),void 0!==e.class&&i.attr("class",e.class),i},m=function(t,e){let i=t.append("circle").attr("cx",e.cx).attr("cy",e.cy).attr("class","face").attr("r",15).attr("stroke-width",2).attr("overflow","visible"),r=t.append("g");return r.append("circle").attr("cx",e.cx-5).attr("cy",e.cy-5).attr("r",1.5).attr("stroke-width",2).attr("fill","#666").attr("stroke","#666"),r.append("circle").attr("cx",e.cx+5).attr("cy",e.cy-5).attr("r",1.5).attr("stroke-width",2).attr("fill","#666").attr("stroke","#666"),e.score>3?function(t){let i=(0,a.Nb1)().startAngle(Math.PI/2).endAngle(3*(Math.PI/2)).innerRadius(7.5).outerRadius(15/2.2);t.append("path").attr("class","mouth").attr("d",i).attr("transform","translate("+e.cx+","+(e.cy+2)+")")}(r):e.score<3?function(t){let i=(0,a.Nb1)().startAngle(3*Math.PI/2).endAngle(5*(Math.PI/2)).innerRadius(7.5).outerRadius(15/2.2);t.append("path").attr("class","mouth").attr("d",i).attr("transform","translate("+e.cx+","+(e.cy+7)+")")}(r):function(t){t.append("line").attr("class","mouth").attr("stroke",2).attr("x1",e.cx-5).attr("y1",e.cy+7).attr("x2",e.cx+5).attr("y2",e.cy+7).attr("class","mouth").attr("stroke-width","1px").attr("stroke","#666")}(r),i},k=function(t,e){let i=t.append("circle");return i.attr("cx",e.cx),i.attr("cy",e.cy),i.attr("class","actor-"+e.pos),i.attr("fill",e.fill),i.attr("stroke",e.stroke),i.attr("r",e.r),void 0!==i.class&&i.attr("class",i.class),void 0!==e.title&&i.append("title").text(e.title),i},_=function(t,e){let i=e.text.replace(/<br\s*\/?>/gi," "),r=t.append("text");r.attr("x",e.x),r.attr("y",e.y),r.attr("class","legend"),r.style("text-anchor",e.anchor),void 0!==e.class&&r.attr("class",e.class);let s=r.append("tspan");return s.attr("x",e.x+2*e.textMargin),s.text(i),r},b=-1,v=function(){return{x:0,y:0,width:100,anchor:"start",height:100,rx:0,ry:0}},$=function(){function t(t,e,i,s,n,a,l,o){let c=e.append("text").attr("x",i+n/2).attr("y",s+a/2+5).style("font-color",o).style("text-anchor","middle").text(t);r(c,l)}function e(t,e,i,s,n,a,l,o,c){let{taskFontSize:h,taskFontFamily:u}=o,y=t.split(/<br\s*\/?>/gi);for(let t=0;t<y.length;t++){let o=t*h-h*(y.length-1)/2,p=e.append("text").attr("x",i+n/2).attr("y",s).attr("fill",c).style("text-anchor","middle").style("font-size",h).style("font-family",u);p.append("tspan").attr("x",i+n/2).attr("dy",o).text(y[t]),p.attr("y",s+a/2).attr("dominant-baseline","central").attr("alignment-baseline","central"),r(p,l)}}function i(t,i,s,n,a,l,o,c){let h=i.append("switch"),u=h.append("foreignObject").attr("x",s).attr("y",n).attr("width",a).attr("height",l).attr("position","fixed"),y=u.append("xhtml:div").style("display","table").style("height","100%").style("width","100%");y.append("div").attr("class","label").style("display","table-cell").style("text-align","center").style("vertical-align","middle").text(t),e(t,h,s,n,a,l,o,c),r(y,o)}function r(t,e){for(let i in e)i in e&&t.attr(i,e[i])}return function(r){return"fo"===r.textPlacement?i:"old"===r.textPlacement?t:e}}(),w={drawRect:x,drawCircle:k,drawSection:function(t,e,i){let r=t.append("g"),s=v();s.x=e.x,s.y=e.y,s.fill=e.fill,s.width=i.width*e.taskCount+i.diagramMarginX*(e.taskCount-1),s.height=i.height,s.class="journey-section section-type-"+e.num,s.rx=3,s.ry=3,x(r,s),$(i)(e.text,r,s.x,s.y,s.width,s.height,{class:"journey-section section-type-"+e.num},i,e.colour)},drawText:_,drawLabel:function(t,e){var i,r;let s=t.append("polygon");s.attr("points",(i=e.x)+","+(r=e.y)+" "+(i+50)+","+r+" "+(i+50)+","+(r+20-7)+" "+(i+50-8.4)+","+(r+20)+" "+i+","+(r+20)),s.attr("class","labelBox"),e.y=e.y+e.labelMargin,e.x=e.x+.5*e.labelMargin,_(t,e)},drawTask:function(t,e,i){let r=e.x+i.width/2,s=t.append("g");b++,s.append("line").attr("id","task"+b).attr("x1",r).attr("y1",e.y).attr("x2",r).attr("y2",450).attr("class","task-line").attr("stroke-width","1px").attr("stroke-dasharray","4 2").attr("stroke","#666"),m(s,{cx:r,cy:300+(5-e.score)*30,score:e.score});let n=v();n.x=e.x,n.y=e.y,n.fill=e.fill,n.width=i.width,n.height=i.height,n.class="task task-type-"+e.num,n.rx=3,n.ry=3,x(s,n);let a=e.x+14;e.people.forEach(t=>{let i=e.actors[t].color,r={cx:a,cy:e.y,r:7,fill:i,stroke:"#000",title:t,pos:e.actors[t].position};k(s,r),a+=10}),$(i)(e.task,s,n.x,n.y,n.width,n.height,{class:"task"},i,e.colour)},drawBackgroundRect:function(t,e){let i=x(t,{x:e.startx,y:e.starty,width:e.stopx-e.startx,height:e.stopy-e.starty,fill:e.fill,class:"rect"});i.lower()},getTextObj:function(){return{x:0,y:0,fill:void 0,"text-anchor":"start",width:100,height:100,textMargin:0,rx:0,ry:0}},getNoteRect:v,initGraphics:function(t){t.append("defs").append("marker").attr("id","arrowhead").attr("refX",5).attr("refY",2).attr("markerWidth",6).attr("markerHeight",4).attr("orient","auto").append("path").attr("d","M 0,0 V 4 L6,2 Z")}},M={},T=(0,s.g)().journey,S=T.leftMargin,E={data:{startx:void 0,stopx:void 0,starty:void 0,stopy:void 0},verticalPos:0,sequenceItems:[],init:function(){this.sequenceItems=[],this.data={startx:void 0,stopx:void 0,starty:void 0,stopy:void 0},this.verticalPos=0},updateVal:function(t,e,i,r){void 0===t[e]?t[e]=i:t[e]=r(i,t[e])},updateBounds:function(t,e,i,r){let n=(0,s.g)().journey,a=this,l=0;this.sequenceItems.forEach(function(s){l++;let o=a.sequenceItems.length-l+1;a.updateVal(s,"starty",e-o*n.boxMargin,Math.min),a.updateVal(s,"stopy",r+o*n.boxMargin,Math.max),a.updateVal(E.data,"startx",t-o*n.boxMargin,Math.min),a.updateVal(E.data,"stopx",i+o*n.boxMargin,Math.max),a.updateVal(s,"startx",t-o*n.boxMargin,Math.min),a.updateVal(s,"stopx",i+o*n.boxMargin,Math.max),a.updateVal(E.data,"starty",e-o*n.boxMargin,Math.min),a.updateVal(E.data,"stopy",r+o*n.boxMargin,Math.max)})},insert:function(t,e,i,r){let s=Math.min(t,i),n=Math.max(t,i),a=Math.min(e,r),l=Math.max(e,r);this.updateVal(E.data,"startx",s,Math.min),this.updateVal(E.data,"starty",a,Math.min),this.updateVal(E.data,"stopx",n,Math.max),this.updateVal(E.data,"stopy",l,Math.max),this.updateBounds(s,a,n,l)},bumpVerticalPos:function(t){this.verticalPos=this.verticalPos+t,this.data.stopy=this.verticalPos},getVerticalPos:function(){return this.verticalPos},getBounds:function(){return this.data}},A=T.sectionFills,I=T.sectionColours,C=function(t,e,i){let r=(0,s.g)().journey,n="",a=2*r.height+r.diagramMarginY,l=i+a,o=0,c="#CCC",h="black",u=0;for(let[i,s]of e.entries()){if(n!==s.section){c=A[o%A.length],u=o%A.length,h=I[o%I.length];let a=0,l=s.section;for(let t=i;t<e.length;t++)if(e[t].section==l)a+=1;else break;let y={x:i*r.taskMargin+i*r.width+S,y:50,text:s.section,fill:c,num:u,colour:h,taskCount:a};w.drawSection(t,y,r),n=s.section,o++}let a=s.people.reduce((t,e)=>(M[e]&&(t[e]=M[e]),t),{});s.x=i*r.taskMargin+i*r.width+S,s.y=l,s.width=r.diagramMarginX,s.height=r.diagramMarginY,s.colour=h,s.fill=c,s.num=u,s.actors=a,w.drawTask(t,s,r),E.insert(s.x,s.y,s.x+s.width+r.taskMargin,450)}},P={setConf:function(t){let e=Object.keys(t);e.forEach(function(e){T[e]=t[e]})},draw:function(t,e,i,r){let n;let o=(0,s.g)().journey;r.db.clear(),r.parser.parse(t+"\n");let c=(0,s.g)().securityLevel;"sandbox"===c&&(n=(0,a.Ys)("#i"+e));let h="sandbox"===c?(0,a.Ys)(n.nodes()[0].contentDocument.body):(0,a.Ys)("body");E.init();let u=h.select("#"+e);w.initGraphics(u);let y=r.db.getTasks(),p=r.db.getDiagramTitle(),d=r.db.getActors();for(let t in M)delete M[t];let f=0;d.forEach(t=>{M[t]={color:o.actorColours[f%o.actorColours.length],position:f},f++}),function(t){let e=(0,s.g)().journey,i=60;Object.keys(M).forEach(r=>{let s=M[r].color,n={cx:20,cy:i,r:7,fill:s,stroke:"#000",pos:M[r].position};w.drawCircle(t,n);let a={x:40,y:i+7,fill:"#666",text:r,textMargin:5|e.boxTextMargin};w.drawText(t,a),i+=20})}(u),E.insert(0,0,S,50*Object.keys(M).length),C(u,y,0);let g=E.getBounds();p&&u.append("text").text(p).attr("x",S).attr("font-size","4ex").attr("font-weight","bold").attr("y",25);let x=g.stopy-g.starty+2*o.diagramMarginY,m=S+g.stopx+2*o.diagramMarginX;(0,l.c)(u,x,m,o.useMaxWidth),u.append("line").attr("x1",S).attr("y1",4*o.height).attr("x2",m-S-4).attr("y2",4*o.height).attr("stroke-width",4).attr("stroke","black").attr("marker-end","url(#arrowhead)");let k=p?70:0;u.attr("viewBox",`${g.startx} -25 ${m} ${x+k}`),u.attr("preserveAspectRatio","xMinYMin meet"),u.attr("height",x+k+25)}},j={parser:o,db:f,renderer:P,styles:g,init:t=>{P.setConf(t.journey),f.clear()}}}}]);